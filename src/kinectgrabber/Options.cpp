...
Options::Options(int argc, char** argv) : m_descr("Supported options")
{
	...
	m_descr.add_options()
		        ...
		        ("voxelsize,v", value<float>(&m_voxelsize)->default_value(0.05), "Voxelsize of grid used for reconstruction.")
                ...
                ("fillHoles,f", value<int>(&m_fillHoles)->default_value(50), "Maximum size for hole filling")
		        ...
		        ("kd", value<int>(&m_kd)->default_value(100), "Number of normals used for distance function evaluation")
		        ("ki", value<int>(&m_ki)->default_value(100), "Number of normals used in the normal interpolation process")
		        ("kn", value<int>(&m_kn)->default_value(100), "Size of k-neighborhood used for normal estimation")

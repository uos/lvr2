...
{
    vtkSmartPointer<vtkProperty> p = m_wireframeActor->GetProperty();
    float* color = this->m_color;
    float r = (float)1 - m_color[0];
    float g = (float)1 - m_color[1];
    float b = (float)1 - m_color[2];
    p->SetColor(r, g, b);

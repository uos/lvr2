...
public:
	...
	void printStats();
	void check_next_neighbor(int startIndex, HalfEdgeFace* face, hash_map<unsigned int, HalfEdge*>* points);
	void extract_borders();

	inline int freeman3D(HalfEdge* edge);
	inline int classifyFace(HalfEdgeFace*);


};


int HalfEdgeMesh::classifyFace(HalfEdgeFace* face){

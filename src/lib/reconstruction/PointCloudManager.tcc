...
template<typename VertexT, typename NormalT>
void PointCloudManager<VertexT, NormalT>::init()
{
...
template<typename VertexT, typename NormalT>
void PointCloudManager<VertexT, NormalT>::interpolateSurfaceNormals()
{
...
template<typename VertexT, typename NormalT>
bool PointCloudManager<VertexT, NormalT>::boundingBoxOK(const float &dx, const float &dy, const float &dz)
{
    /**
...
template<typename VertexT, typename NormalT>
void PointCloudManager<VertexT, NormalT>::getkClosestVertices(const VertexT &v,
...
template<typename VertexT, typename NormalT>
float PointCloudManager<VertexT, NormalT>::meanDistance(const Plane<VertexT, NormalT> &p,
...
template<typename VertexT, typename NormalT>
float PointCloudManager<VertexT, NormalT>::distance(VertexT v, Plane<VertexT, NormalT> p)
{
    return fabs((v - p.p) * p.n);
}

template<typename VertexT, typename NormalT>
void PointCloudManager<VertexT, NormalT>::distance(VertexT v, float &projectedDistance, float &euklideanDistance)
{
    int k = this->m_kd;
...
template<typename VertexT, typename NormalT>
VertexT PointCloudManager<VertexT, NormalT>::fromID(int i){
    return VertexT(
            this->m_points[i][0],
            this->m_points[i][1],
            this->m_points[i][2]);
...
template<typename VertexT, typename NormalT>
Plane<VertexT, NormalT> PointCloudManager<VertexT, NormalT>::calcPlane(const VertexT &queryPoint,
        const int &k,

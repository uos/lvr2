...
public:
    ...
    typedef boost::shared_ptr< mPointCloudManager<VertexT, NormalT> > Ptr;

	/**
	 * @brief Trys to read the given file to create a new mPointCloudManager
	 *        instance.
	 *
...
#include "mPointCloudManager.tcc"

...
template<typename VertexT, typename NormalT>
   SearchTreePCL< VertexT, NormalT >::SearchTreePCL( coord3fArr points, long unsigned int &n_points, const int &kn, const int &ki, const int &kd ) 
   {
      // Store parameters
      this->m_ki = ki;
      this->m_kn = kn;
...
template<typename VertexT, typename NormalT>
   SearchTreePCL< VertexT, NormalT >::~SearchTreePCL() { 
   }


template<typename VertexT, typename NormalT>
   void SearchTreePCL< VertexT, NormalT >::kSearch( coord< float > &qp, int neighbours, vector< ulong > &indices, vector< double > &distances )
   {
...
*/
template<typename VertexT, typename NormalT>
   void SearchTreePCL< VertexT, NormalT >::radiusSearch( float qp[3], double r, vector< ulong > &indices )
   {
      // TODO: Implement me!
   }
...
template<typename VertexT, typename NormalT>
   void SearchTreePCL< VertexT, NormalT >::radiusSearch( VertexT& qp, double r, vector< ulong > &indices )
   {
      float qp_arr[3];
      qp_arr[0] = qp[0];
      qp_arr[1] = qp[1];
...
template<typename VertexT, typename NormalT>
   void SearchTreePCL< VertexT, NormalT >::radiusSearch( const VertexT& qp, double r, vector< ulong > &indices )
   {
      float qp_arr[3];
      qp_arr[0] = qp[0];
      qp_arr[1] = qp[1];
...
template<typename VertexT, typename NormalT>
   void SearchTreePCL< VertexT, NormalT >::radiusSearch( coord< float >& qp, double r, vector< ulong > &indices )
   {
      float qp_arr[3];
      qp_arr[0] = qp[0];
      qp_arr[1] = qp[1];
...
template<typename VertexT, typename NormalT>
   void SearchTreePCL< VertexT, NormalT >::radiusSearch( const coord< float >& qp, double r, vector< ulong > &indices )
   {
      float qp_arr[3];

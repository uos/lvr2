...
template<typename VertexT, typename NormalT>
void mPointCloudManager<VertexT, NormalT>::init()
{
...
template<typename VertexT, typename NormalT>
void mPointCloudManager<VertexT, NormalT>::calcNormals()
{
    int k_0 = this->m_kn;
...
template<typename VertexT, typename NormalT>
void mPointCloudManager<VertexT, NormalT>::interpolateSurfaceNormals()
{
    ...
    for(size_t i = 0; i < this->m_numPoints; i++){
        ...
        m_searchTree->kSearch(this->m_points[i], this->m_ki, id, di);
...
template<typename VertexT, typename NormalT>
bool mPointCloudManager<VertexT, NormalT>::boundingBoxOK(const float &dx, const float &dy, const float &dz)
{
    /**
...
template<typename VertexT, typename NormalT>
void mPointCloudManager<VertexT, NormalT>::getkClosestVertices(const VertexT &v,
...
template<typename VertexT, typename NormalT>
float mPointCloudManager<VertexT, NormalT>::meanDistance(const Plane<VertexT, NormalT> &p,
...
template<typename VertexT, typename NormalT>
float mPointCloudManager<VertexT, NormalT>::distance(VertexT v, Plane<VertexT, NormalT> p)
{
    return fabs((v - p.p) * p.n);
}

template<typename VertexT, typename NormalT>
void mPointCloudManager<VertexT, NormalT>::distance(VertexT v, float &projectedDistance, float &euklideanDistance)
{
    int k = this->m_kd;
    ...
    //Allocate ANN point
    {
        ...
        m_searchTree->kSearch( p, k, id, di );
    }
...
template<typename VertexT, typename NormalT>
VertexT mPointCloudManager<VertexT, NormalT>::fromID(int i){
    return VertexT(
            this->m_points[i][0],
            this->m_points[i][1],
            this->m_points[i][2]);
...
template<typename VertexT, typename NormalT>
Plane<VertexT, NormalT> mPointCloudManager<VertexT, NormalT>::calcPlane(const VertexT &queryPoint,
        const int &k,
...
template<typename VertexT, typename NormalT>
Plane<VertexT, NormalT> mPointCloudManager<VertexT, NormalT>::calcPlaneRANSAC(const VertexT &queryPoint,
        const int &k,
        const vector<unsigned long> &id)
{
    VertexT point1;
...
template<typename VertexT, typename NormalT>
void mPointCloudManager<VertexT, NormalT>::save(string filename)
{

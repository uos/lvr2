...
float** PLYIO::interlacedBufferToIndexedBuffer(float* src, size_t n)
{
...
float* PLYIO::indexedBufferToInterlacedBuffer(float** src, size_t n)
{
...
void PLYIO::setIndexedVertexArray(float** arr, size_t vertex_count)
{
...
bool PLYIO::containsElement(string name)
{
	vector<PLYElement*>::iterator it;
	PLYElement* element;
	for(it = m_elements.begin(); it != m_elements.end(); it++)

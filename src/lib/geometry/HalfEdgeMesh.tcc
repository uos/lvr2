...
void HalfEdgeMesh<VertexT, NormalT>::tesselatorEnd()
{
    ...
    if(primitive == GL_TRIANGLES)
        for(int i=0; i<tessVertices.size(); ++i)
        {
            ...
            tess << tessVertices[i].x  << " " << tessVertices[i].y << " " << tessVertices[i].z << endl;
            if((i+1)%3==0 && i != 0)
                tess << tessVertices[i-2].x << " " << tessVertices[i-2].y << " " << tessVertices[i-2].z << "\n#EndTriangle<<\n\n";
        }
    ...
    if(primitive == GL_TRIANGLE_FAN)
        for(int i=0; i<tessVertices.size()-2; ++i)
        {
            ...
            tess << tessVertices[0].x   << " " << tessVertices[0].y   << " " << tessVertices[0].z   << endl
                 << tessVertices[i+1].x << " " << tessVertices[i+1].y << " " << tessVertices[i+1].z << endl
                 << tessVertices[i+2].x << " " << tessVertices[i+2].y << " " << tessVertices[i+2].z << endl
                 << tessVertices[0].x   << " " << tessVertices[0].y   << " " << tessVertices[0].z   << endl << endl;
        }
    ...
    if(primitive == GL_TRIANGLE_STRIP)
        for(int i=0; i<tessVertices.size()-2; ++i)
        {
            ...
            tess << tessVertices[i].x   << " " << tessVertices[i].y   << " " << tessVertices[i].z   << endl
                 << tessVertices[i+1].x << " " << tessVertices[i+1].y << " " << tessVertices[i+1].z << endl
                 << tessVertices[i+2].x << " " << tessVertices[i+2].y << " " << tessVertices[i+2].z << endl
                 << tessVertices[i].x   << " " << tessVertices[i].y   << " " << tessVertices[i].z   << endl << endl;
        }
    ...
    //{
        ...
        //{
            ...
            for(int k=0; k<tessTriangles.size(); ++k)
            {
                ...
                v.m_position[0] = tessTriangles[k].x;
                v.m_position[1] = tessTriangles[k].y;
                v.m_position[2] = tessTriangles[k].z;
                tp.push_back(v);
            }

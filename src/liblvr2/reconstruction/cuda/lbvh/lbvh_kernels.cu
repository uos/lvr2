...
#include "lvr2/reconstruction/cuda/lbvh/morton_code.cuh"
...
__global__ void lbvh::compute_morton_kernel(const AABB* __restrict__ aabbs,
...
__global__ void lbvh::compute_morton_points_kernel(float* __restrict__ const points,  
...
__forceinline__ __device__ void initialize_internal_node(unsigned int internal_index, BVHNode *nodes) {
    ...
    BVHNode* internal = &nodes[internal_index];
...
__global__ void lbvh::initialize_tree_kernel(BVHNode *nodes,
...
__global__ void lbvh::construct_tree_kernel(BVHNode *nodes,
...
__global__ void lbvh::optimize_tree_kernel(BVHNode *nodes,
                                     unsigned int* root_index,
                                     unsigned int* valid,
...
__global__ void lbvh::compute_free_indices_kernel(const unsigned int* valid_sums,
...
__global__ void lbvh::compact_tree_kernel(BVHNode *nodes,
                                     unsigned int* root_index,

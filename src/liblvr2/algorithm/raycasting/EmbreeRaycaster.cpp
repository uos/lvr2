...
//     {
//         *reinterpret_cast<float*>(it) = rayhit.ray.org_x + rayhit.ray.tfar * rayhit.ray.dir_x;
//         it += sizeof(float);
//         *reinterpret_cast<float*>(it) = rayhit.ray.org_y + rayhit.ray.tfar * rayhit.ray.dir_y;
//         it += sizeof(float);
//         *reinterpret_cast<float*>(it) = rayhit.ray.org_z + rayhit.ray.tfar * rayhit.ray.dir_z;
//         it += sizeof(float);
//     }

//     if(flags & INTERSECT::DISTANCE)
//     {
//         *reinterpret_cast<float*>(it) = rayhit.ray.tfar;
//         it += sizeof(float);
//     }
    
//     if(flags & INTERSECT::NORMAL)
//     {
//         *reinterpret_cast<float*>(it) = rayhit.hit.Ng_x;
//         it += sizeof(float);
//         *reinterpret_cast<float*>(it) = rayhit.hit.Ng_y;
//         it += sizeof(float);
//         *reinterpret_cast<float*>(it) = rayhit.hit.Ng_z;
//         it += sizeof(float);
//     }

//     if(flags & INTERSECT::FACE)
//     {
//         *reinterpret_cast<unsigned int*>(it) = rayhit.hit.primID;
//         it += sizeof(unsigned int);
//     }

//     if(flags & INTERSECT::BARYCENTRICS)
//     {
//         *reinterpret_cast<float*>(it) = rayhit.hit.u;
//         it += sizeof(float);
//         *reinterpret_cast<float*>(it) = rayhit.hit.v;
//         it += sizeof(float);
//     }

//     if(flags & INTERSECT::MESH)
//     {
//         *reinterpret_cast<unsigned int*>(it) = rayhit.hit.geomID;
//         it += sizeof(unsigned int);
//     }

...
void PLYElement::addProperty(string name, string value_type, string count_type)
{
	...
	PLYProperty* s = new ScalarProperty(name, value_type);


	if(list_property)
	{
		PLYProperty* l = new ListProperty(s, count_type);
...
vector<PLYProperty*>::iterator PLYElement::getFirstProperty()
{
	return m_properties.begin();
}

vector<PLYProperty*>::iterator PLYElement::getLastProperty()
{

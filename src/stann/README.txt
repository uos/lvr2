...
Simple Thread-safe Approximate Nearest Neigbor (STANN)
Version 1.0_beta
...
STANN has been tested using gcc version 4.2.1
...
sfcnn:
	...
	k	   :   The number of nearest neighbors to return.  Ie. k=5 will
        ...
        epsilon    :   This parameter is optional, and defaults to 0.
		       This approximation parmater garuntees that the
		       distance to the farthest returned point is
		       no farther than (1+eplsilon)*(distance to actual k

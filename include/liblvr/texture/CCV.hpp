...
public:
	...
	*/
	...
	std::map< uchar, std::pair<unsigned long, unsigned long> > m_CCV_r; 

	//The CCV for the g channel
	std::map< uchar, std::pair<unsigned long, unsigned long> > m_CCV_g; 

	//The CCV for the b channel
	std::map< uchar, std::pair<unsigned long, unsigned long> > m_CCV_b; 
private:
	/**
	...
	*		connected component
	*/
	std::map<ushort, std::pair<uchar, unsigned long> >calcCoherence(cv::Mat inputColors, cv::Mat inputLabels);

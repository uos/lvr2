...
public:
    ...
    virtual Description fullWaveform(const size_t &scanPosNo, const size_t &scanNo) const;
    virtual Description fullWaveform(const std::string &scanPositionPath, const size_t &scanNo) const;

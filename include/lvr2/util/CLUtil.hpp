...
/**
 * @brief Util class for CL that maps error codes to human readable strings
 */
class CLUtil
{
public:
    ...
    /**
     * @brief Util method that maps error codes to CL error strings
     *
     * @param error the given error code
     *
     * @return the CL error string
     */
    ...
    /**
     * @brief Util method that maps error codes to CL error description messages
     *
     * @param error the given error code
     *
     * @return the CL error description messages
     */
    static inline const char* getErrorDescription(cl_int error)
    {
        ...
        {
            // run-time and JIT compiler errors
            case 0: return "Indicates that the function executed successfully.";
            case -1: return "Returned by clGetDeviceIDs and clCreateContextFromType if no OpenCL devices that match "
                            "the specified devices were found.";
            case -2: return "Returned by clCreateContext and clCreateContextFromType if the specified device is not "
                            "currently available.";
            case -3: return "Returned by clBuildProgram if the parameter program is created with "
                            "clCreateProgramWithSource and a compiler is not available. For example "
                            "CL_DEVICE_COMPILER_AVAILABLE is set to CL_FALSE.";
            case -4: return "Returned by the functions listed below if there is a failure to allocate memory for data "
            ...
            case -5: return "Returned by clEnqueueNDRangeKernel, clEnqueueTask, and clEnqueueNativeKernel in the event "
            ...
            case -6: return "Returned by the functions listed below in the event of a failure to allocate resources "
            ...
            case -7: return "Returned by clGetEventProfilingInfo if the CL_QUEUE_PROFILING_ENABLE flag is not set for "
            ...
            case -8: return "Returned by clEnqueueCopyBuffer and clEnqueueCopyImage if the source and destination "
            ...
            case -9: return "Returned by clEnqueueCopyImage if the specified source and destination images are not "
                            "valid image objects.";
            case -10: return "Returned by clCreateImage2D and clCreateImage3D if the specified image format is not "
                             "supported.";
            case -11: return "Returned by clBuildProgram if there is a failure to build the program executable. This "
                             "error will be returned if clBuildProgram does not return until the build has completed.";
            case -12: return "Returned by clEnqueueMapBuffer and clEnqueueMapImage if there is a failure to map the "
            ...
            // compile-time errors
            case -30: return "Returned by the functions listed below if a parameter is not an expected value. The "
                             "exact condition that generates this error depends on the calling function. Refer to the "
                             "function for more information.";
            case -31: return "Returned by clGetDeviceIDs and clCreateContextFromType if device type specified is not "
                             "valid.";
            case -32: return "Returned by clGetPlatformInfo and clGetDeviceIDs if the specified platform is not a "
                             "valid platform.\n"
                             ...
                             "platform.";
            case -33: return "Returned by the functions listed below if the device or devices specified are not valid. "
                             "The exact condition that generates this error depends on the calling function. Refer to "
                             "the function for more information.";
            case -34: return "Returned by the functions listed below if the specified context is not a valid OpenCL "
                             "context, or the context associated with certain parameters are not the same. The exact "
                             "condition that generates this error depends on the calling function. Refer to the "
                             "function for more information.";
            case -35: return "Returned by clCreateCommandQueue and clSetCommandQueueProperty if specified properties "
                             "are valid but are not supported by the device.";
            case -36: return "Returned by the functions listed below if the specified command-queue is not a valid "
            ...
            case -37: return "Returned by the functions listed below if host_ptr is NULL and CL_MEM_USE_HOST_PTR or "
            ...
            case -38: return "Returned by the functions listed below if a parameter is not a valid memory, image, or "
                             "buffer object. The exact condition that generates this error depends on the calling "
                             "function. Refer to the function for more information.";
            case -39: return "Returned by clCreateImage2D and clCreateImage3D if the image format specified is not "
                             "valid or is NULL.\n"
            ...
            case -40: return "Returned by clCreateImage2D if the specified image width or height are 0 or if they "
            ...
            case -41: return "Returned by clRetainSampler, clReleaseSampler, and clGetSamplerInfo if the specified "
            ...
            case -42: return "Returned by clBuildProgram and clCreateProgramWithBinary if the program binary is not a "
                             "valid binary for the specified device.";
            case -43: return "Returned by clBuildProgram if the specified build options are invalid.";
            case -44: return "Returned by clCreateKernel if there is no successfully built executable for program, and "
            ...
            case -45: return "Returned by clCreateKernel if there is no successfully built executable for program, and "
                             "returned by clCreateKernelsInProgram if there is no device in program.\n"
                             "Returned by clEnqueueNDRangeKernel and clEnqueueTask if there is no successfully built "
                             "program executable available for device associated with command_queue. ";
            case -46: return "Returned by clCreateKernel if the specified kernel name is not found in program.";
            case -47: return "Returned by clCreateKernel if the function definition for __kernel function given by "
            ...
            case -48: return "Returned by the functions listed below if the specified kernel is not a valid kernel "
            ...
            case -49: return "Returned by clSetKernelArg if an invalid argument index is specified.";
            case -50: return "Returned by clSetKernelArg if the argument value specified is NULL for an argument that "
                             "is not declared with the __local qualifier or vice-versa.";
            case -51: return "Returned by clSetKernelArg if argument size specified (arg_size) does not match the size "
                             ...
                             "sizeof(cl_sampler).";
            case -52: return "Returned by clEnqueueNDRangeKernel and clEnqueueTask if the kernel argument values have "
                             "not been specified.";
            case -53: return "Returned by clEnqueueNDRangeKernel if work_dim is not a valid value.";
            case -54: return "Returned by clEnqueueNDRangeKernel and clEnqueueTask if local_work_size is specified and "
                             ...
                             "source.";
            case -55: return "Returned by clEnqueueNDRangeKernel if the number of work-items specified in any of "
            ...
            case -56: return "Returned by clEnqueueNDRangeKernel if global_work_offset is not NULL.";
            case -57: return "Returned by the functions listed below if event_wait_list is NULL and "
                             ...
                             "condition that generates this error depends on the calling function. Refer to the "
                             "function for more information.";
            case -58: return "Returned by the functions listed below if the event objects specified are not valid. The "
                             "exact condition that generates this error depends on the calling function. Refer to the "
                             "function for more information.";
            case -59: return "Returned by clCreateImage2D, clCreateImage3D, and clCreateSampler if there are no "
                             ...
                             "embedded profile. ";
            case -60: return "Returned by clCreateFromGLBuffer if bufobj is not a GL buffer object or is a GL buffer "
            ...
            case -61: return "Returned by clCreateBuffer if the value of the parameter size is 0 or is greater than "

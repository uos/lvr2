...
"unsigned int GetKdTreePosition(__global const float* D_kd_tree_values, const unsigned int num_values,__global const unsigned char* D_kd_tree_splits , const unsigned int num_splits, float x, float y, float z) \n"
"{ \n"
"    unsigned int pos = 0; \n"
...
"} \n"
" \n"
"__kernel void NormalEstimationKernel(__global const float* D_V, const unsigned int num_points,__global const float* D_kd_tree_values, const unsigned int num_values,__global const unsigned char* D_kd_tree_splits , const unsigned int num_splits,__global float* D_Normals, const unsigned int num_pointnormals,const unsigned int k,const float flip_x, const float flip_y, const float flip_z) \n"
"{ \n"
...
"    { \n"
"        unsigned int pos = GetKdTreePosition(D_kd_tree_values, num_values,D_kd_tree_splits, num_splits,D_V[tid * 3], D_V[tid * 3 + 1], D_V[tid * 3 +2] ); \n"

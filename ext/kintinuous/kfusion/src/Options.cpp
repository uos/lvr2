...
Options::Options(int argc, char** argv) : m_descr("Supported options")
{
	...
	m_descr.add_options()
		        ...
		        ("pnt", value<float>(&m_planeNormalThreshold)->default_value(0.95), "(Plane Normal Threshold) Normal threshold for plane optimization. Default 0.85 equals about 3 degrees.")
		        ...
		        ("lft", value<float>(&m_lineFusionThreshold)->default_value(0.005), "(Line Fusion Threshold) Threshold for fusing line segments while tesselating.")		        

...
/*
===============================================================================
                       LASwriteItemCompressed_WAVEPACKET13_v2
===============================================================================
*/
...
LASwriteItemCompressed_WAVEPACKET13_v2::LASwriteItemCompressed_WAVEPACKET13_v2(EntropyEncoder* enc)
{
  /* set encoder */
  assert(enc);
  this->enc = enc;
...
LASwriteItemCompressed_WAVEPACKET13_v2::~LASwriteItemCompressed_WAVEPACKET13_v2()
{
...
BOOL LASwriteItemCompressed_WAVEPACKET13_v2::init(const U8* item)
{
  /* init state */
  last_diff_32 = 0;
...
inline BOOL LASwriteItemCompressed_WAVEPACKET13_v2::write(const U8* item)
{

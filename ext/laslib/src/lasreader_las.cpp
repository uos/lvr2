...
//        fprintf(stderr,"WARNING: wrong header.vlrs[%d].reserved: %d != 0xAABB\n", i, header.vlrs[i].reserved);
      ...
      if (header.vlrs[i].record_length_after_header)
      {
        ...
        else if (strcmp(header.vlrs[i].user_id, "lastools tile") == 0 || strcmp(header.vlrs[i].user_id, "finalized tile") == 0 || strcmp(header.vlrs[i].user_id, "lastiling tile") == 0)
        {
          ...
          {
            fprintf(stderr,"ERROR: record_length_after_header of %s VLR is %d instead of 28\n", header.vlrs[i].user_id, header.vlrs[i].record_length_after_header);
            return FALSE;
          }
        }
        else
        {
          ...
          try { stream->getBytes((U8*)header.vlrs[i].data, header.vlrs[i].record_length_after_header); } catch(...)
          {
      ...
      else if (strcmp(header.vlrs[i].user_id, "laszip encoded") == 0 || strcmp(header.vlrs[i].user_id, "lastools tile") == 0 || strcmp(header.vlrs[i].user_id, "finalized tile") == 0 || strcmp(header.vlrs[i].user_id, "lastiling tile") == 0)
      {
